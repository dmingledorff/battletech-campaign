  ...
  <div class="col-md-6">
    <div class="card shadow mb-3">
      ...
      <div class="card-body">
        ...
        <p>
          <?php
          $armorPct   = ($equipment['max_armor']     ?? 0) > 0 ? round($equipment['current_armor']     / $equipment['max_armor']     * 100) : 0;
          $structPct  = ($equipment['max_structure'] ?? 0) > 0 ? round($equipment['current_structure'] / $equipment['max_structure'] * 100) : 0;
          ?>
          <div class="row g-1 mt-1" style="font-size:0.65rem;">
            <div class="col-3">
              <div class="d-flex justify-content-between text-muted mb-1">
                <span>Armor</span>
                <span><?= $equipment['current_armor'] ?? 0 ?>/<?= $equipment['max_armor'] ?? 0 ?></span>
              </div>
            ...
            <div class="col-3">
              <div class="d-flex justify-content-between text-muted mb-1">
                <span>Structure</span>
                <span><?= $equipment['current_structure'] ?? 0 ?>/<?= $equipment['max_structure'] ?? 0 ?></span>
              </div>
              <div class="progress" style="height:4px; background:#333;">
